...
CONFIGFOLDER='/root/.swag'
COIN_DAEMON='swagd'
COIN_CLI='swag-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/zcoinofficial/zcoin/releases/download/v0.13.6.4/zcoin-0.13.6.4-linux64.tar.gz'
...
function important_information() {
 ...
 echo -e "${GREEN}swag-cli masternode status${NC}"
 echo -e "${GREEN}swag-cli getinfo.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
}
